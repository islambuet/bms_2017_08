...
class Setup_direct_cost_items extends Root_Controller
{
    ...
    private function system_list()
    {
        ...
        {
            $data['title']='Direct Cost Items List';
            $ajax['status']=true;
    ...
    {
        $this->db->from($this->config->item('table_bms_setup_direct_cost_items'));
        $this->db->select('*');
    ...
    private function system_save()
    {
        ...
        else
        {
            ...
            if($id>0)
            {
                ...
                $this->db->update($this->config->item('table_bms_setup_direct_cost_items'));

                $data['user_updated'] = $user->user_id;
                $data['date_updated'] = $time;
                Query_helper::update($this->config->item('table_bms_setup_direct_cost_items'),$data,array("id = ".$id),$save_history=true);
            }
            else
            {
                $data['revision']=1;
                ...
                Query_helper::add($this->config->item('table_bms_setup_direct_cost_items'),$data,$save_history=true);
            }

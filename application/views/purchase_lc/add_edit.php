...
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="item[consignment_name]" id="consignment_name" class="form-control" value="<?php echo $item['consignment_name'];?>"<?php echo $disabled; ?>/>
            </div>
        </div>
        <div class="row show-grid">
            <div class="col-xs-4">
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function()
    {
        ...
        $(document).on("click", ".system_button_add_more", function(event)
        {
            ...
            $(content_id+' .price').attr('name','varieties['+current_id+'][amount_price_order]');

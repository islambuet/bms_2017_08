...
{
    if($month_wise_target_info['status_target']=='Forwarded')
    {
    ...
    else
    {
        ...
        if($month_wise_target_info['status_target']=='Not Forwarded')
        {
            $action_buttons[]=array(
                'type'=>'button',
...
<div class="row widget">
    ...
    <div style="" class="row show-grid">
        <div class="col-xs-4">
            <label class="control-label pull-right">Month Wise Target Status</label>
        </div>
        <div class="col-sm-4 col-xs-8">
            <label class="control-label"><?php echo $month_wise_target_info['status_target'];?></label>
        </div>
    </div>
    <div style="" class="row show-grid">
        <div class="col-xs-4">
        ...
        <div class="col-sm-4 col-xs-8">
            <label class="control-label"><?php echo $month_wise_target_info['user_target'];?></label>
        </div>
    </div>
    <div style="" class="row show-grid">
        <div class="col-xs-4">
        ...
        <div class="col-sm-4 col-xs-8">
            <label class="control-label"><?php echo $month_wise_target_info['date_target'];?></label>
        </div>
    </div>
    <div style="" class="row show-grid">
        <div class="col-xs-4">
            <label class="control-label pull-right">Month Wise Target Forwarded By</label>
        </div>
        <div class="col-sm-4 col-xs-8">
            <label class="control-label"><?php echo $month_wise_target_info['user_forward'];?></label>
        </div>
    </div>
    <div style="" class="row show-grid">
        <div class="col-xs-4">
        ...
        <div class="col-sm-4 col-xs-8">
            <label class="control-label"><?php echo $month_wise_target_info['date_forward'];?></label>
        </div>
    </div>
    <?php
    /*if(isset($CI->permissions['action6']) && ($CI->permissions['action6']==1))
    {
        ...
        <div class="col-xs-12" style="margin-bottom: 20px;">
            <div class="col-xs-12" style="margin-bottom: 20px;">
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column" value="year0_ti_quantity_budget">TI Budget (<?php echo $year_current['text']; ?>)</label>
                <?php
                ...
                {
                    ?>
                    <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column" value="year<?php echo ($i+1); ?>_ti_quantity_budget">TI Budget (<?php echo $years_next[$i]['text']; ?>)</label>
                    <?php
                    foreach($areas as $area)
                    {
                        ?>
    ...
    $(document).ready(function ()
    {
        ...
        $(document).on("click", "#button_action_save_jqx", function(event)
        {
            ...
            for(var i=0;i<data.length;i++)
            {
                ...
                {
                    ?>
                    $('#save_form_jqx  #jqx_inputs').append('<input type="hidden" name="items['+data[i]['variety_id']+'][target_quantity_<?php echo $month_no; ?>]" value="'+data[i]['month<?php echo $month_no; ?>_quantity_target']+'">');
                    <?php
                }
                ?>
            }
        ...
        var source =
        {
            ...
            dataFields: [
                ...
                foreach($months as $month_no=>$month_name)
                {
                    ...
                    {
                        ?>
                        { name: 'year<?php echo $year['value']; ?>_month<?php echo $month_no; ?>_quantity_target', type: 'string' },
                        { name: 'year<?php echo $year['value']; ?>_month<?php echo $month_no; ?>_sell_quantity', type: 'string' },
                        <?php
                    }
                    ?>
                    { name: 'month<?php echo $month_no; ?>_quantity_target', type: 'string' },
                    { name: 'month<?php echo $month_no; ?>_quantity_target_editable', type: 'string' },
                    <?php
                }
                ?>
            ],
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columngroups:[
                    ...
                    foreach($months as $month_no=>$month_name)
                    {
                        ...
                        {
                            ?>
                            { parentgroup: 'previous_year_month<?php echo $month_no; ?>',text: '<?php echo $year['text']; ?>', align: 'center', name: 'year<?php echo $year['value']; ?>_month<?php echo $month_no; ?>' },
                            <?php
                        }
                        ?>
                        { parentgroup: 'month<?php echo $month_no; ?>',text: 'Previous Year', align: 'center', name: 'previous_year_month<?php echo $month_no; ?>' },
                        { parentgroup: 'month<?php echo $month_no; ?>',text: 'Current Year', align: 'center', name: 'current_year_month<?php echo $month_no; ?>' },
                        { text: '<?php echo $month_name; ?>', align: 'center', name: 'month<?php echo $month_no; ?>' },
                        <?php
                    }
                    ?>
                ]

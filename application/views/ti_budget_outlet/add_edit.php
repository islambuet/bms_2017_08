        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    {
                        columngroup: 'budgeted_year',text: 'Budget', dataField: '<?php echo 'year0_budget_quantity';?>',align:'center',width:'100',cellsrenderer: cellsrenderer,cellsAlign:'right',columntype:'custom',
                ...
                columngroups:
                    [
                        ...
                        { text: '<?php echo $CI->lang->line('LABEL_BUDGETED_YEAR').'('.$year_current['text'].')'; ?>', align: 'center', name: 'budgeted_year' },

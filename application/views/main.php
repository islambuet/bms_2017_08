...
$results=Query_helper::get_info($CI->config->item('table_login_csetup_cus_info'),array('customer_id value','name text','district_id'),array('type =1','revision =1'),0,0,array('ordering ASC'));

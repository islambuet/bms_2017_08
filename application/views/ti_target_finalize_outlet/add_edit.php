...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        var source =
        {
            ...
            {
                ?>
                { name: 'year<?php echo $i; ?>_ti_quantity_budget', type: 'string' },
                { name: 'year<?php echo $i; ?>_ti_quantity_target', type: 'string' },
                <?php
                foreach($areas as $area)
                {
                    ?>
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                {
                    ?>
                    { columngroup: 'year<?php echo $i; ?>',text: 'TI Budget', dataField: 'year<?php echo $i; ?>_ti_quantity_budget',align:'center',width:'75',cellsAlign:'right',cellsrenderer: cellsrenderer,hidden:true,editable:false},
                    { columngroup: 'year<?php echo $i; ?>',text: 'TI Target', dataField: 'year<?php echo $i; ?>_ti_quantity_target',align:'center',width:'75',cellsAlign:'right',cellsrenderer: cellsrenderer,editable:false},
                    <?php
                    foreach($areas as $area)
                    {
                        ?>
                    ...
                    { columngroup: 'year<?php echo $i; ?>_area_<?php echo $area['value']; ?>',text: 'Prev. Target', dataField: 'year<?php echo $i; ?>_area<?php echo $area['value']; ?>_previous_target',align:'center',width:'70',cellsAlign:'right',cellsrenderer: cellsrenderer,editable:false},
                    { columngroup: 'year<?php echo $i; ?>_area_<?php echo $area['value']; ?>',text: 'Prev. Prediction Target', dataField: 'year<?php echo $i; ?>_area<?php echo $area['value']; ?>_previous_prediction_target',align:'center',width:'70',cellsAlign:'right',cellsrenderer: cellsrenderer,editable:false},

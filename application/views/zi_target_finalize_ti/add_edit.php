        ...
        var source =
        {
            ...
            dataFields: [
                ...
                <?php
                    ...
                    {
                        ?>
                        { name: 'year<?php echo $i; ?>_zi_quantity_budget', type: 'string' },
                        { name: 'year<?php echo $i; ?>_zi_quantity_target', type: 'string' },
                        <?php
                        foreach($areas as $area)
                        {
                            ?>
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    <?php
                        ...
                        {
                            ?>
                            { columngroup: 'year<?php echo $i; ?>',text: 'ZI Budget', dataField: 'year<?php echo $i; ?>_zi_quantity_budget',align:'center',width:'75',cellsAlign:'right',cellsrenderer: cellsrenderer,hidden:true,editable:false},
                            { columngroup: 'year<?php echo $i; ?>',text: 'ZI Target', dataField: 'year<?php echo $i; ?>_zi_quantity_target',align:'center',width:'75',cellsAlign:'right',cellsrenderer: cellsrenderer,editable:false},
                            <?php
                            foreach($areas as $area)
                            {
                                ?>

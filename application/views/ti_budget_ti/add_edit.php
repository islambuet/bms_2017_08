        ...
        var source =
        {
            ...
            dataFields: [
                ...
                <?php
                    ...
                    {?>{ name: '<?php echo 'area_quantity_'.$area['id'];?>', type: 'string' },
                        <?php
                    }
                ?>
                <?php
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    <?php
                        foreach($areas as $area)
                        {?>{ columngroup: 'areas',text: '<?php echo $area['area_name'];?>', dataField: '<?php echo 'area_quantity_'.$area['id'];?>',align:'center',width:'100',cellsrenderer: cellsrenderer,cellsAlign:'right',editable:false},
                            <?php
                        }
                    ?>
                    <?php
                    ...
                    { columngroup: 'year0',text: 'Prev.Prediction',dataField: 'year0_previous_prediction',width:'100',cellsrenderer: cellsrenderer,align:'center',cellsAlign:'right',editable:false},
                        <?php
                            for($i=0;$i<=sizeof($years_next);$i++)
                            {?>{ columngroup: '<?php echo 'year'.($i); ?>',text: 'Outlet', dataField: '<?php echo 'year'.($i).'_area_quantity';?>',align:'center',width:'80',cellsrenderer: cellsrenderer,cellsAlign:'right',editable:false},
                        { columngroup: '<?php echo 'year'.($i); ?>',text: 'TI', dataField: '<?php echo 'year'.($i).'_budget_quantity';?>',align:'center',width:'100',cellsrenderer: cellsrenderer,cellsAlign:'right',columntype:'custom',
                ...
                columngroups:
                    [
                        ...
                        ?>
                        { text: 'Outlets', align: 'center', name: 'areas' }
